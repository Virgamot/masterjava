...
public class AkkaUntypedSendServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        HttpServletRequest acReq = (HttpServletRequest) ac.getRequest();
        HttpServletResponse acResp = (HttpServletResponse) ac.getResponse();

        executorService.submit(() -> {
            try {
                doAndWriteResponse(acResp, () -> sendAkka(createMailObject(acReq)));
            } catch (IOException e) {
