...
//        DBIProvider.getDBI().useHandle(h -> h.execute("ALTER SEQUENCE user_seq RESTART WITH " + (id + step)));
    ...
    @SqlUpdate("INSERT INTO users (full_name, email, flag, city_id, group_id) VALUES (:fullName, :email, CAST(:flag AS USER_FLAG), :city_id, :group_id) ")
    @GetGeneratedKeys
    abstract int insertGeneratedId(@BindBean User user);

    @SqlUpdate("INSERT INTO users (id, full_name, email, flag, city_id, group_id) VALUES (:id, :fullName, :email, CAST(:flag AS USER_FLAG), :city_id, :group_id) ")
    ...
    @SqlBatch("INSERT INTO users (id, full_name, email, flag, city_id, group_id) VALUES (:id, :fullName, :email, CAST(:flag AS USER_FLAG), :city_id, :group_id)" +
